...
public class MapContext {
    ...
    /**
     * Convenient array based arguments for assembling hash-map of string values
     * For Example. new MapContext("client","system","lob","technology")
     * results in client=>system, lob=>technology
     * So if you want to a match, client becomes the key and technology becomes the value
     *
